...
import mdu.mydsl.formatting2.MyDslFormatter;
import mdu.mydsl.generator.MyDslGenerator;
import mdu.mydsl.parser.antlr.MyDslAntlrTokenFileProvider;
import mdu.mydsl.parser.antlr.MyDslParser;
import mdu.mydsl.parser.antlr.internal.InternalMyDslLexer;
import mdu.mydsl.scoping.MyDslScopeProvider;
import mdu.mydsl.serializer.MyDslSemanticSequencer;
import mdu.mydsl.serializer.MyDslSyntacticSequencer;
import mdu.mydsl.services.MyDslGrammarAccess;
import mdu.mydsl.validation.MyDslConfigurableIssueCodesProvider;
import mdu.mydsl.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "mdu/mydsl/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("mdu.mydsl.MyDsl");
	}
